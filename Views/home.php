        ...
        <div class="side">
            <div class="side-inner">
              <ul class="nav flex-column">
                ...
                <li class="nav-item my-icon"><img src="../Views/img_uploaded/user/sample-person.jpg" alt="" class=""></li>
              </ul>
            </div>
          </div>
          <div class="main">
              ...
              <div class="tweet">
                <div class="user">
                  <a href="profile.php?user_id=1">
                    <img src="../Views/img_uploaded/user/sample-person.jpg" alt="ユーザーの画像">
                  </a>
                </div>
                <div class="content">
                  <div class="name">
                  ...
                  <div class="icon-list">
                    <div class="like">
                      <img src="../Views/img/icon-heart.svg" alt="黒ハート">
                    </div>
              ...
              <div class="tweet">
                <div class="user">
                  <a href="profile.php?user_id=2">
                    <img src="../Views/img/icon-default-user.svg" alt="デフォルトの人間画像">
                  </a>
                </div>
                <div class="content">
                  <div class="name">
                  ...
                  <img src="../Views/img_uploaded/tweet/sample-post.jpg" alt="コアーキング" class="post-image">
                  <div class="icon-list">
                    <div class="like">
                      <img src="../Views/img/icon-heart-twitterblue.svg" alt="ハート色付き">
                    </div>
